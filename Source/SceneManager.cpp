...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture("textures/desk-top.jpg", "desk");

	bReturn = CreateGLTexture("textures/wood.jpg", "square");

	bReturn = CreateGLTexture("textures/paper.jpg", "paper");

	bReturn = CreateGLTexture("textures/computer.jpg", "computer"); 
...
void SceneManager::RenderScene()
{
	...
	SetShaderColor(255, 255, 255, 255); 
	...
	SetShaderColor (0.128, 0.128, 0.1, 1); 
	SetShaderTexture("computer"); 
	SetShaderMaterial("computer"); 
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(1.0f, 0.0f, 5.0f);
	...
	SetShaderColor(0.195, 0.195, 0.195, 5);
	SetShaderTexture("computer");
	SetShaderMaterial("computer");
