...
private:
	...
	void SetShaderColor(glm::vec3 RGB);

	void SetShaderTexture(int textureSlot);

	void SetTextureUVScale(float UVScale);

	void SetShaderMaterial(OBJECT_MATERIAL material);
